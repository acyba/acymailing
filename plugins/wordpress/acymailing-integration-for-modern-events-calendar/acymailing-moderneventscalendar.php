...
class AcyMailingIntegrationForModernEventsCalendar
{
    const INTEGRATION_PLUGIN_NAME = 'plgAcymModerneventscalendar';
...
new AcyMailingIntegrationForModernEventsCalendar();
