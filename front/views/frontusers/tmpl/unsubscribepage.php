...
<form action="<?php echo acym_frontendLink('frontusers'); ?>"
	...
	<fieldset>
		...
		<div class="acym_front_page__unsubscribe__lists__actions">
			...
			<button type="button" class="button margin-right-1" id="acym__save" onclick="return acymSubmitForm('saveSubscriptions');">
                <?php echo acym_translation('ACYM_UPDATE'); ?>
			</button>
			<button type="button" class="button button-secondary" id="acym__unsub__all" onclick="return acymSubmitForm('unsubscribeAll');">
