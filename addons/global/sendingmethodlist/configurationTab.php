        ...
        <?php foreach ($sendingMethods as $id => $sendingMethod) { ?>
			<div class="grid-x cell acym__listing__row">
				<div class="cell medium-4">
                    <?php echo acym_escapeHtml($sendingMethod['name']); ?>
				</div>
				<div class="cell medium-3">
                    <?php echo acym_escapeHtml($sendingMethod['mailer_method']); ?>
				</div>
				<div class="cell medium-3 acym__configuration__sml__actions" data-acym-method-id="<?php echo acym_escape($id); ?>">
					...
					<i class="acymicon-delete cursor-pointer margin-left-1 acym__configuration__sml__delete"></i>
				</div>
			</div>
        <?php } ?>
	</div>
...
<button type="button" id="acym__configuration__sml__toggle" class="button button-secondary margin-top-2">
    <?php echo acym_escapeHtml(acym_translation('ACYM_ADD_SENDING_METHOD')); ?>
</button>
<div id="acym__configuration__sml__form" class="margin-top-2" style="display: none;">
	<h5 class="acym__title acym__title__secondary cell">
        <?php echo acym_escapeHtml(acym_translation('ACYM_SENDING_METHOD')); ?>
	</h5>
	<div class="cell grid-x">
		<label for="acym__configuration__sml__name"><?php echo acym_escapeHtml(acym_translation('ACYM_SENDING_METHOD_NAME')); ?></label>
	...
	<div class="cell grid-x">
		...
		<button class="button acy_button_submit" data-task="addNewSml"><?php echo acym_escapeHtml(acym_translation('ACYM_SAVE_METHOD')); ?></button>
	</div>
</div>
