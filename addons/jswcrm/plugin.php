...
class plgAcymJswcrm extends AcymPlugin
{
    ...
    public function __construct()
    {
        ...
        $this->addonDefinition = [
            'name' => 'JSW CRM',
            'description' => '- Insert JSW CRM files in your emails',
            'documentation' => 'https://docs.acymailing.com/addons/joomla-add-ons/jsw-crm',
            'category' => 'Files management',
            'level' => 'starter',
        ];
        $this->installed = acym_isExtensionActive('com_jswcrm');
        $this->rootCategoryId = 0;

        $this->pluginDescription->name = 'Jswcrm';
