	...
	<div class="cell grid-y medium-4 medium-margin-right-1 text-center acym__list__settings__subscriber__nb">
		...
		<div class="cell small-10 align-center acym_vcenter acym__list__settings__subscriber__nb__display grid-x">
			<div class="cell grid-x">
				...
				<div class="cell small-4 text-right"><a href="<?php echo $url; ?>" class="acym__color__blue"><?php echo $data['listInformation']->subscribers['sendable_users']; ?>
						&nbsp;</a></div>
                ...
                if ($this->config->get('require_confirmation', 1) == 1) {
                    ...
                    ?>
					<div class="cell small-4 text-right"><a href="<?php echo $url; ?>"
															class="acym__color__blue"><?php echo $data['listInformation']->subscribers['unconfirmed_users']; ?>&nbsp;</a></div>
                ...
                ?>
				<div class="cell small-4 text-right"><a href="<?php echo $url; ?>" class="acym__color__blue"><?php echo $data['listInformation']->subscribers['inactive_users']; ?>
						&nbsp;</a></div>
				...
				<div class="cell small-4 text-right"><a href="<?php echo $url; ?>"
														class="acym__color__blue"><?php echo $data['listInformation']->subscribers['unsubscribed_users']; ?>&nbsp;</a></div>
