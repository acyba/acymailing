<form id="acym_form" action="<?php echo acym_completeLink(acym_getVar('cmd', 'ctrl')); ?>" method="post" name="acyForm">
	<div id="acym__email__new" class="cell grid-x grid-margin-y align-center acym__content margin-top-2 acym__selection">
		...
		<div class="cell grid-x grid-margin-x align-center margin-y">
			...
			<div class="acym__selection__card <?php echo !acym_level(1) ? 'acym__selection__card__disabled' : ''; ?> cell xxlarge-2 large-3 medium-4 text-center"
			...
			<div class="acym__selection__card <?php echo !acym_level(2) ? 'acym__selection__card__disabled' : ''; ?> cell xxlarge-2 large-3 medium-4 text-center"
