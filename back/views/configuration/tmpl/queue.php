	...
	<div class="acym__content acym_area padding-vertical-1 padding-horizontal-2 margin-bottom-2">
		...
		<div class="grid-x grid-margin-x margin-y">
			...
			<div class="cell medium-9 automatic_only automatic_manual acym_auto_send_time">
                <?php
                $hoursFrom = acym_select($listHours, 'config[queue_send_from_hour]', $this->config->get('queue_send_from_hour', '00'), 'class="intext_select"');
                $minutesFrom = acym_select($listAllMinutes, 'config[queue_send_from_minute]', $this->config->get('queue_send_from_minute', '00'), 'class="intext_select"');
                $hoursTo = acym_select($listHours, 'config[queue_send_to_hour]', $this->config->get('queue_send_to_hour', '23'), 'class="intext_select"');
                $minutesTo = acym_select($listAllMinutes, 'config[queue_send_to_minute]', $this->config->get('queue_send_to_minute', '59'), 'class="intext_select"');
