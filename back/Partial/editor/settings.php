...
<div id="acym__wysid__right__toolbar__settings" style="display: none;" class="cell grid-padding-x acym__wysid__right__toolbar--menu">
	<p class="acym__wysid__right__toolbar__p__open acym__wysid__right__toolbar__p acym__title">
        <?php echo acym_escapeHtml(acym_translation('ACYM_TEMPLATE_DESIGN')); ?><i class="acymicon-keyboard-arrow-up"></i>
	</p>
	<div class="grid-y acym__wysid__right__toolbar__design--show acym__wysid__context__modal__container">
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__background-size"><?php echo acym_escapeHtml(acym_translation('ACYM_BACKGROUND_SIZE')); ?></label>
			<div class="cell large-6">
                ...
                foreach ($backgroundSize as $groupName => $values) {
                    echo '<optgroup label="'.acym_escape(acym_translation($groupName)).'">';
                    foreach ($values as $value => $label) {
                        $selected = ($defaultBackgroundSize === $value) ? 'selected' : '';
                        echo '<option value="'.acym_escape($value).'" '.acym_escape($selected).'>'.acym_escapeHtml($label).'</option>';
                    }
                    echo '</optgroup>';
                }
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__background-repeat"><?php echo acym_escapeHtml(acym_translation('ACYM_BACKGROUND_REPEAT')); ?></label>
			<div class="cell large-6">
                <?php
                $repeat = [
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__background-position"><?php echo acym_escapeHtml(acym_translation('ACYM_BACKGROUND_POSITION')); ?></label>
			<div class="cell large-6">
                <?php
                $position = [
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label for="acym__wysid__maincolor-colorpicker1" class="cell large-6 small-9" for="acym__wysid__maincolor-colorpicker1">
                <?php echo acym_escapeHtml(acym_translation('ACYM_MAIN_COLORS'));
                acym_info(['textShownInTooltip' => 'ACYM_MAIN_COLORS_DESC']); ?>
			</label>
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__padding__top__content"><?php echo acym_escapeHtml(acym_translation('ACYM_MARGIN_TOP_CONTENT')); ?></label>
			<div class="cell large-6">
				<input type="number" min="0" value="20" id="acym__wysid__padding__top__content" class="cell small-4">
			</div>
		</div>
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__padding__bottom__content"><?php echo acym_escapeHtml(acym_translation('ACYM_MARGIN_BOTTOM_CONTENT')); ?></label>
			<div class="cell large-6">
				<input type="number" min="0" value="20" id="acym__wysid__padding__bottom__content" class="cell small-4">
			</div>
		</div>
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="default_font"><?php echo acym_escapeHtml(acym_translation('ACYM_DEFAULT_FONT')); ?></label>
			<div class="cell large-6">
                <?php
                $fonts = [
	...
	<p class="acym__wysid__right__toolbar__p__open acym__wysid__right__toolbar__p acym__title">
        <?php echo acym_escapeHtml(acym_translation('ACYM_DESIGN')); ?>
		<i class="acymicon-keyboard-arrow-up"></i>
        <?php acym_info(['textShownInTooltip' => 'ACYM_INTRO_CUSTOMIZE_FONT']); ?>
	</p>
	<div class="grid-y acym__wysid__right__toolbar__design--show acym__wysid__right__toolbar__design acym__wysid__context__modal__container">
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__right__toolbar__settings__font--select"><?php echo acym_escapeHtml(acym_translation('ACYM_HTML_TAG')); ?></label>
			<div class="cell large-6">
				<select id="acym__wysid__right__toolbar__settings__font--select" class="small-8 large-4 cell acym__select">
					<option value="p">p - <?php echo acym_escapeHtml(acym_translation('ACYM_PARAGRAPH')); ?></option>
					<option value="a">a - <?php echo acym_escapeHtml(acym_translation('ACYM_LINKS')); ?></option>
					<option value="span.acym_link"><?php echo acym_escapeHtml(acym_translation('ACYM_DYNAMIC_TEXTS_LINKS')); ?></option>
					<option value="li">li - <?php echo acym_escapeHtml(acym_translation('ACYM_BULLET_LIST')); ?></option>
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__right__toolbar__settings__font-family"><?php echo acym_escapeHtml(acym_translation('ACYM_FAMILY')); ?></label>
			<div class="cell large-6">
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__right__toolbar__settings__line-height"><?php echo acym_escapeHtml(acym_translation('ACYM_LINE_HEIGHT')); ?></label>
			<div class="cell large-6">
				<select id="acym__wysid__right__toolbar__settings__line-height" class="auto cell acym__select">
					<option value="inherit"><?php echo acym_escapeHtml(acym_translation('ACYM_DEFAULT')); ?></option>
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell" for="acym__wysid__right__toolbar__settings__font-size"><?php echo acym_escapeHtml(acym_translation('ACYM_SIZE')); ?></label>
			<div class="cell large-6">
		...
		<div class="grid-x margin-bottom-1 small-12 cell">
			<label class="middle large-6 cell"><?php echo acym_escapeHtml(acym_translation('ACYM_STYLE')); ?></label>
	...
	<p class="acym__wysid__right__toolbar__p__open acym__wysid__right__toolbar__p acym__title">
        <?php echo acym_escapeHtml(acym_translation('ACYM_CUSTOM_SOCIAL_ICONS')); ?><i class="acymicon-keyboard-arrow-up"></i></p>
	<div class="grid-y acym__wysid__right__toolbar__design--show acym__wysid__right__toolbar__design acym__wysid__right__toolbar__design__social__icons acym__wysid__context__modal__container">
        ...
        foreach ($socialIcons as $social => $iconUrl) {
            echo '<div class="cell grid-x margin-bottom-2 acym_vcenter acym__wysid__right__toolbar__design__social__icons__one">
                        				...
                        				<div class="auto cell grid-x text-center align-center acym_vcenter"><span class="shrink cell acym__wysid__social__icons__import__text">'.acym_escapeHtml(
                    acym_translation(
                        'ACYM_SELECT_NEW_ICON'
                    )
                ).'</span></div>
                        				<button disabled type="button" class="button cell shrink acym__wysid__social__icons__import">'.acym_escapeHtml(
