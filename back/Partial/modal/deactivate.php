	...
	<div class="acym_deactivate_modal_dialog">
		<div class="acym_deactivate_modal_header">
			<div class="acym_deactivate_modal_title_container">
				<h3 id="acym_deactivate_modal_h3"><?php echo acym_escapeHtml(acym_translation('ACYM_QUICK_FEEDBACK')); ?></h3>
			</div>
		...
		<div class="acym_deactivate_modal_body">
			<div id="acym_deactivate_modal_body_container" class="medium-7">
				<div>
					<h4 id="acym_deactivate_modal_title"><?php echo acym_escapeHtml(acym_translation('ACYM_WHY_YOU_UNINSTALL_ACYMAILING')); ?></h4>
				</div>
				<ul id="acym_deactivate_modal_list">
					<li>
						<label for="acym_deactivate_modal_list_reason1">
                            ...
                            <?php echo acym_escapeHtml(acym_translation('ACYM_FOUND_BETTER_PLUGIN')); ?>
						</label>
					</li>
					<li>
						<label for="acym_deactivate_modal_list_reason2">
                            ...
                            <?php echo acym_escapeHtml(acym_translation('ACYM_NO_NEEDED')); ?>
						</label>
					</li>
					<li>
						<label for="acym_deactivate_modal_list_reason3">
                            ...
                            <?php echo acym_escapeHtml(acym_translation('ACYM_PLUGIN_NOT_WORKING')); ?>
						</label>
					</li>
					<li>
						<label for="acym_deactivate_modal_list_reason4">
                            ...
                            <?php echo acym_escapeHtml(acym_translation('ACYM_TEMPORARY_DEACTIVATION')); ?>
						</label>
					</li>
					<li>
						<label for="acym_deactivate_modal_list_otherReason">
                            ...
                            <?php echo acym_escapeHtml(acym_translation('ACYM_OTHER')); ?>
				...
				<div id="acym_feedback_contact_container_display">
					<div>
						<h4 id="acym_deactivate_modal_information_title"><?php echo acym_escapeHtml(acym_translation('ACYM_CONTACT_INFORMATION')); ?></h4>
					</div>
					<div>
					...
					<div id="acym_feedback_contact_checkbox_container">
						...
						<label for="acym_feedback_contact_checkbox">
                            <?php echo acym_escapeHtml(acym_translation('ACYM_FEEDBACK_SEND_USER_EMAIL')); ?>
						</label>
					</div>
				</div>
			</div>
		...
		<div class="acym_deactivate_modal_footer">
			...
			<a href="#" class="acym_deactivate_button button acym_deactivate_button_deactivate">
                <?php echo acym_escapeHtml(acym_translation('ACYM_SKIP_AND_DEACTIVATE')); ?>
			</a>
		</div>
	</div>
</div>
