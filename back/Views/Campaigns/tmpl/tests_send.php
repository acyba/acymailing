...
<div id="send_test_zone" class="cell large-6">
	<h6 class="acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_SEND_TEST_TO')); ?></h6>
    <?php
    acym_selectMultiple(
        $data['test_emails'],
        'test_emails',
	...
	<label class="margin-top-1">
		...
		<textarea
				...
				name="test_note"
				type="text"
				placeholder="<?php echo acym_escape(acym_translation('ACYM_TEST_NOTE_PLACEHOLDER', true)); ?>"></textarea>
	</label>
	<div class="grid-x">
