<div id="acym__fields__splashscreen" class="cell grid-x">
	<div class="cell grid-x acym__splashscreen__bloc margin-top-2">
		...
		<div class="cell large-8 grid-x text-center">
			<h3 class="cell acym__title text-center"><i class="acymicon-paper-plane acym__color__green margin-right-1"></i><?php echo acym_translation(
	...
	<div class="cell grid-x acym__splashscreen__bloc">
		<div class="cell large-2 hide-for-medium-only hide-for-small-only"></div>
		<div class="cell large-8 grid-x text-center">
			<h3 class="cell acym__title text-center"><i class="acymicon-bell acym__color__orange margin-right-1"></i><?php echo acym_translation('ACYM_WHY_USE_FOLLOWUPS'); ?>
			</h3>
	...
	<div class="cell grid-x acym__splashscreen__bloc">
		<div class="cell large-2 hide-for-medium-only hide-for-small-only"></div>
		<div class="cell large-8 grid-x text-center">
			<h3 class="cell acym__title text-center"><i class="acymicon-access-time acym__color__light-blue margin-right-1"></i><?php echo acym_translation(
