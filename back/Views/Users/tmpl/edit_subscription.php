...
<div class="acym__content cell grid-x acym__users__display__subscriptions--list">
	<h5 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_LISTS')); ?></h5>
	<div class="cell acym__content__tab">
        ...
        $data['tab']->addCallbackElement(
            function () {
                echo '<div class="acym__users__display__list--action acym__user__action--unsubscribeall">
					<i class="acymicon-times-circle"></i><span>'.acym_escapeHtml(acym_translation('ACYM_UNSUBSCRIBE_ALL')).'</span>
				</div>';
            },
        ...
        $data['tab']->addCallbackElement(
            function () {
                echo '<div class="acym__users__display__list--action acym__user__action--resubscribeall">
					<i class="acymicon-add"></i><span>'.acym_escapeHtml(acym_translation('ACYM_RESUBSCRIBE_ALL')).'</span>
				</div>';
            },
