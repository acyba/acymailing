		...
		<div class="acym__walkthrough cell grid-x" id="acym__walkthrough__thank_you">
			<div class="acym__content cell grid-x acym__walkthrough__content acym__walkthrough__main align-center">
				<h1 class="cell acym__title acym__main_title text-center">
                    <?php echo acym_escapeHtml(acym_translationSprintf('ACYM_WALKTHROUGH_LICENCE_TITLE', $data['level'])); ?>
				</h1>
				<div class="cell text-center"><?php echo acym_escapeHtml(acym_translation('ACYM_ONBOARDING_FEW_STEPS_AWAY')); ?></div>

				<button type="submit" class="button margin-top-1"><?php echo acym_escapeHtml(acym_translation('ACYM_START_SETUP')); ?></button>
			</div>
			...
			<div class="acym__content cell grid-x acym__walkthrough__footer align-center">
				<button type="submit" class="button margin-top-2"><?php echo acym_escapeHtml(acym_translation('ACYM_START_SETUP')); ?></button>
			</div>
		</div>
	</div>
