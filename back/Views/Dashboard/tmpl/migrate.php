...
?>
<form id="acym_form" action="<?php echo acym_escapeUrl(acym_completeLink(acym_getVar('cmd', 'ctrl'))); ?>" method="post" name="acyForm" class="acym__form__migrate">
	<div id="acym_migrate" class="cell grid-x">
		<div class="text-center cell acym__migrate__titles">
			<h1 class="acym__title text-center"><?php echo acym_escapeHtml(acym_translation('ACYM_THANKS_FOR_INSTALLING_ACYM')); ?></h1>
			<h2 class="acym__migrate__subtitle"><?php echo acym_escapeHtml(acym_translation('ACYM_DO_YOU_WANT_TO_MIGRATE')); ?></h2>
		</div>
		...
		<div class="acym__content acym__content__reduced cell large-6 grid-x">
			<div class="text-center cell acym__migrate__content__titles">
				<h1 class="acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_WHICH_DATA_TO_MIGRATE')); ?></h1>
				<p class="acym__color__red"><b><?php echo acym_escapeHtml(acym_translation('ACYM_MIGRATE_WARNING_DATA_OVERWRITE')); ?></b></p>
			</div>
			<div class="cell acym__migrate__input__element acym_vcenter">
				...
				<label for="acym__migrate__config"><?php echo acym_escapeHtml(acym_translation('ACYM_CONFIGURATION')); ?></label>
            ...
            <?php if (acym_level(ACYM_ENTERPRISE)) { ?>
				<div class="cell acym__migrate__input__element acym_vcenter">
					...
					<label for="acym__migrate__bounce"><?php echo acym_escapeHtml(acym_translation('ACYM_BOUNCE_HANDLING')); ?></label>
				...
				<div class="cell acym__migrate__input__element acym_vcenter">
					...
					<label for="acym__migrate__distrib"><?php echo acym_escapeHtml(acym_translation('ACYM_DISTRIBUTION_LISTS')); ?></label>
			...
			<div class="cell acym__migrate__input__element acym_vcenter">
				...
				<label for="acym__migrate__lists"><?php echo acym_escapeHtml(acym_translation('ACYM_LISTS')); ?></label>
			...
			<div class="cell acym__migrate__input__element acym_vcenter">
				...
				<label for="acym__migrate__mails"><?php echo acym_escapeHtml(acym_translation('ACYM_NEWSLETTERS')); ?></label>
			...
			<div class="cell acym__migrate__input__element acym_vcenter margin-left-2" id="acym__migrate__input__global_stats">
				...
				<label for="acym__migrate__mailstats"><?php echo acym_escapeHtml(acym_translation('ACYM_GLOBAL_STATS')); ?></label>
			...
			<div class="cell acym__migrate__input__element acym_vcenter">
				...
				<label for="acym__migrate__templates"><?php echo acym_escapeHtml(acym_translation('ACYM_TEMPLATES')); ?></label>
            ...
            <?php if (acym_level(ACYM_ENTERPRISE)) { ?>
				<div class="cell acym__migrate__input__element acym_vcenter">
					...
					<label for="acym__migrate__fields"><?php echo acym_escapeHtml(acym_translation('ACYM_CUSTOM_FIELDS')); ?></label>
			...
			<div class="cell acym__migrate__input__element acym_vcenter">
				...
				<label for="acym__migrate__users"><?php echo acym_escapeHtml(acym_translation('ACYM_SUBSCRIBERS')); ?></label>
			...
			<div class="cell grid-x text-center align-right grid-margin-x">
				<button type="button"
				        ...
				        id="acym__migrate__no__button"><?php echo acym_escapeHtml(acym_translation('ACYM_NO_DONT_WANT_TO_MIGRATE_MY_DATA')); ?></button>
				<button type="button" class="button primary cell medium-shrink small-12" id="acym__migrate__button"><?php echo acym_escapeHtml(
                        acym_translation('ACYM_MIGRATE')
                    ); ?></button>
				...
				<div class="cell grid-x" style="display: none">
					<h1 class="acym__title acym__title__secondary cell"><?php echo acym_escapeHtml(acym_translation('ACYM_DISPLAY_GIF')); ?></h1>
					<img src="" alt="gif to wait" id="acym__migration__gif" class="cell">
				</div>
			</div>
			<div class="cell grid-x text-center" id="acym__migrate__result__ok">
				<h2 class="cell acym__listing__empty__subtitle"><?php echo acym_escapeHtml(acym_translation('ACYM_MIGRATION_DONE')); ?></h2>
			...
			<div class="cell acym__color__red grid-x align-center" id="acym__migrate__result__error">
				...
				<button type="button" id="acym__migrate__restart_from_error__button" class="button cell margin-right-1 medium-shrink">
                    <?php echo acym_escapeHtml(acym_translation('ACYM_RESTART_FROM_ERROR')); ?>
				</button>
				<button type="button" data-task="migrationDone" class="button button-secondary cell acy_button_submit medium-shrink">
                    <?php echo acym_escapeHtml(acym_translation('ACYM_IGNORE_ERRORS_AND_CONTINUE')); ?>
				</button>
			</div>
		</div>
		<div class="cell large-3"></div>
