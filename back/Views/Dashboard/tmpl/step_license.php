	...
	<div id="acym__walkthrough">
		<div class="acym__walkthrough cell grid-x" id="acym__walkthrough__license">
			<div class="acym__content cell text-center grid-x acym__walkthrough__content align-center">
				...
				<h1 class="cell acym__title text-center"><?php echo acym_escapeHtml(acym_translation('ACYM_CONNECT_YOUR_ACYMAILING_LICENSE')); ?></h1>
				<div class="cell">
					<p>
                        <?php
                        if (acym_level(ACYM_ESSENTIAL)) {
                            echo acym_escapeHtml(acym_translationSprintf('ACYM_ENTER_LICENSE_KEY_TO_ACTIVATE_ACYM_X_FEATURES', $data['level']));
                        } else {
                            echo acym_escapeHtml(acym_translation('ACYM_STARTER_LICENSE_KEY'));
                        }
                        ?>
					</p>
					<p> (<?php acym_externalLink('ACYM_FIND_YOUR_LICENSE', ACYM_ACYMAILING_WEBSITE.'account/license/'); ?>)</p>
				</div>
					...
					<div class="cell large-10 xlarge-8 xxlarge-6 grid-x grid-margin-y text-left">
						<div class="cell grid-x grid-margin-x">
							<label class="cell large-3" for="acym__walkthrough__license__key">
                                ...
                                acym_info(['textShownInTooltip' => 'ACYM_LICENSE_DESC']); ?>
							</label>
							<div class="cell large-9 grid-x grid-margin-x">
								...
								<div class="cell small-6 grid-x grid-margin-x">
									<button type="button"
                                        ...
                                        <?php echo acym_escapeHtml(acym_translation('ACYM_ATTACH_MY_LICENSE')); ?>
									</button>
						...
						<div class="cell grid-x grid-margin-x">
							<label class="cell large-3">
                                <?php echo acym_escapeHtml(acym_translation('ACYM_STATUS_ACTIVATION')); ?>
							</label>
							<div class="cell large-9 acym__color__red" id="acym__walk_through_license__licenseStatus">
                                <?php echo acym_escapeHtml(acym_translation('ACYM_NOT_ENABLED_YET')); ?>
							</div>
						</div>
                        ...
                        <?php if (acym_level(ACYM_ESSENTIAL)) { ?>
							<div class="cell grid-x grid-margin-x">
								<label class="cell large-3">
                                    <?php echo acym_escapeHtml(acym_translation('ACYM_AUTOMATED_TASKS'));
                                    acym_info(['textShownInTooltip' => 'ACYM_AUTOMATED_TASKS_DESC']); ?>
								</label>
								<div class="cell large-9 grid-x grid-margin-x">
									<div class="cell small-6 margin-left-0 acym__color__red" id="acym__walk_through_license__cron_label">
                                        <?php echo acym_escapeHtml(acym_translation('ACYM_DEACTIVATED')); ?>
									</div>
				...
				<button type="submit" class="button"><?php echo acym_escapeHtml(acym_translation('ACYM_CONTINUE')); ?></button>
			</div>
		</div>
	</div>
