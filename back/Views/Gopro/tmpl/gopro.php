...
<div class="cell grid-x align-center">
	...
	<div class="acym__splashscreen__white__container cell grid-x grid-margin-y grid-margin-x align-center margin-top-1">
        <?php include acym_getView('gopro', 'header'); ?>
	</div>
	<div class="acym__splashscreen__blue__container cell grid-x grid-margin-y grid-margin-x align-center margin-top-1">
        <?php include acym_getView('gopro', 'content'); ?>
