...
<div class="cell grid-x align-center">
	<h2 class="cell acym__title text-center"><?php echo acym_escapeHtml(acym_translation('ACYM_DISCOVER_ALL_FEATURES')); ?></h2>
</div>
<div class="cell grid-x grid-margin-x align-center">
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-6 small-10 padding-1 acym__walkthrough__card acym__walkthrough__card__left">
		<div class="cell grid-x medium-6 acym__gopro__text">
			<div class="cell">
				<h3 class=" acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_AUTO_SEND_PROCESS')); ?></h3>
                ...
                ?>
				<a class="button <?php echo acym_escape($btnClass); ?> margin-top-1" href="<?php echo acym_escapeUrl($btnUrl); ?>" target="_blank"><?php echo acym_escapeHtml(
                        $btnText
                    ); ?></a>
			</div>
		</div>
	...
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-4 small-10 padding-1 acym__walkthrough__card">
		...
		<div class="cell grid-x acym__gopro__text">
			<h3 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_SUBSCRIPTION_FORMS')); ?></h3>
...
<div class="cell grid-x grid-margin-x align-center">
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-4 small-10 padding-1 acym__walkthrough__card acym__walkthrough__card__left">
		...
		<div class="cell grid-x acym__gopro__text">
			<h3 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_ADVANCED_STATISTICS')); ?></h3>
	...
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-6 small-10 padding-1 acym__walkthrough__card">
		<div class="cell grid-x medium-6 acym__gopro__text">
			<h3 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_CUSTOM_FIELDS')); ?></h3>
...
<div class="cell grid-x grid-margin-x align-center">
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-6 small-10 padding-1 acym__walkthrough__card acym__walkthrough__card__left">
		<div class="cell grid-x medium-6 acym__gopro__text">
			<h3 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_GOPRO_NEWSLETER_OF_YOUR_CHOICE')); ?></h3>
	...
	<div class="cell grid-x grid-margin-x grid-margin-y xxlarge-4 small-10 padding-1 acym__walkthrough__card">
		<div class="cell grid-x align-center acym__gopro__override">
			<img class="cell acym__gopro__images"
			     src="<?php echo acym_escapeUrl(ACYM_IMAGES).'upgrade/overrides.png'; ?>"
			     alt="Fictional welcome email">
		</div>
		<div class="cell grid-x acym__gopro__text">
			<h3 class="cell acym__title acym__title__secondary"><?php echo acym_escapeHtml(acym_translation('ACYM_EMAILS_OVERRIDE')); ?></h3>
			<p><?php echo acym_escapeHtmlWithAllowedTags(
