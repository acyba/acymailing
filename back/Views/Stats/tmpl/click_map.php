...
<form id="acym_form" action="<?php echo acym_escapeUrl(acym_completeLink(acym_getVar('cmd', 'ctrl'))); ?>" method="post" name="acyForm">
	<div class="acym__content acym__content__tab" id="acym_stats">
        ...
        $workflow->displayTabs($this->tabs, 'clickMap');
        ?>
		<div id="acym__stats__click-map" class="acym__content">
			...
			<div class="cell grid-x">
				<div class="cell grid-x align-right">
					<button type="button" class="cell shrink button primary  acym__stats__export__click-map__charts"><?php echo acym_escapeHtml(
                            acym_translation('ACYM_EXPORT')
                        ); ?></button>
				</div>
				<div id="acym__stats__add_style_export__click-map">
					<style>
						<?php
        				// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Applying internal CSS for isolated zone.
