...
<form id="acym_form" action="<?php echo acym_escapeUrl(acym_completeLink(acym_getVar('cmd', 'ctrl'))); ?>" method="post" name="acyForm">
	<div id="acym_content" class="acym__content cell grid-x popup_size">
		<div class="cell margin-bottom-1">
			<h1 class="acym__modal__language__share__title cell text-center margin-bottom-1"><?php echo acym_escapeHtml(acym_translation('ACYM_SHARE_TRANSLATION')); ?></h1>
			<div class="acym__modal__language__share__information">
				<h6 class="margin-bottom-1"><?php echo acym_escapeHtmlWithAllowedTags(acym_translation('ACYM_SHARE_CONFIRMATION_1'), ['b' => []]); ?></h6>
				<h6><?php echo acym_escapeHtml(acym_translation('ACYM_SHARE_CONFIRMATION_2')); ?></h6>
				<h6><?php echo acym_escapeHtml(acym_translation('ACYM_SHARE_CONFIRMATION_3')); ?></h6>
			</div>
			<h3 class="acym__title acym__title__secondary margin-top-1"><?php echo acym_escapeHtml(acym_translation('ACYM_EMAIL_BODY')); ?></h3>
