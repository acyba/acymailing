...
<div class="acym__content cell grid-x margin-bottom-1 margin-y">
	<span class="cell acym__content__title__light-blue"><?php echo acym_escapeHtml(acym_translation('ACYM_ACTIONS')); ?></span>
	<div class="cell"><?php echo acym_escapeHtml(acym_translation('ACYM_EMAIL_REMOVED_AFTER_ACTIONS')); ?></div>

	<div class="cell grid-x margin-y">
		<input type="hidden" id="acym__mailbox__edition__action__number" value="0">
		<input type="hidden" id="acym__mailbox__edition__actions" value="<?php echo acym_escape(json_encode($data['mailboxActions']->actions)); ?>">
