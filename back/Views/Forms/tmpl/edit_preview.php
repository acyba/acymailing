...
<div class="cell grid-x acym__content" id="acym__forms__preview">
	<div class="cell acym_vcenter" id="acym__forms__preview__bar">
		...
		<span class="acym__forms__preview__bar__search"><?php echo acym_escapeHtml(ACYM_LIVE); ?></span>
	</div>
	<iframe src="<?php echo acym_escapeUrl(ACYM_LIVE).'?acym_preview=1'; ?>" id="acym__forms__preview__content" class="cell"></iframe>
	<div id="acym__forms__preview__content__loader" class="grid-x cell align-center acym_vcenter" v-if="loading"><?php acym_loaderLogo(); ?></div>
</div>
