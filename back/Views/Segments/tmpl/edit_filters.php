...
<div class="cell grid-x acym_vcenter padding-bottom-1 acym__segments__edit__filters__info__users">
	<h3 class="cell shrink acym__title__primary__color margin-right-1"><?php echo acym_escapeHtml(acym_translation('ACYM_NUMBER_OF_ACYMAILING_USERS_MATCHING_CONDITIONS')); ?></h3>
	<span class="cell shrink acym__segments__edit__filters__total"></span>
	<span class="cell shrink acym__segments__edit__filters__no-users" style="display: none"><?php echo acym_escapeHtml(
            acym_translation(
...
<div id="acym__automation__or__example" style="display: none;">
	<div class="cell grid-x acym__segments__or__container">
		<h6 class="cell acym__content__title__light-blue margin-top-1 margin-next-1 shrink">
            <?php echo acym_escapeHtml(acym_translation('ACYM_OR')); ?>
		</h6>
		<span class="cell acym_vcenter shrink acym__segments__delete__one__or">
			<i class="acymicon-delete"></i>
			<?php echo acym_escapeHtml(acym_translation('ACYM_DELETE_THIS_BLOCK')); ?>
		</span>
		<div class="cell grid-x acym__content acym__segments__group__filter" data-filter-number="">
			...
			<div class="cell grid-x margin-top-2">
				<button data-filter-type="classic"
                    ...
                    <?php echo acym_escapeHtml(acym_translation('ACYM_ADD_FILTER')); ?>
				</button>
			</div>
		</div>
	</div>
