...
CREATE TABLE IF NOT EXISTS `#__acym_list` (
    ...
    `unsubscribed_users` INT DEFAULT 0,
	`new_sub` INT DEFAULT 0,
    `new_unsub` INT DEFAULT 0,
	PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `#__acym_scenario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__acym_scenario` (
	`id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `#__acym_scenario_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__acym_scenario_step` (
...
-- -----------------------------------------------------
-- Table `#__acym_scenario_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__acym_scenario_process` (
	`id` INT NOT NULL AUTO_INCREMENT,
	`scenario_id` INT NOT NULL,
	`user_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `#__acym_scenario_queue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__acym_scenario_queue` (
	`id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `#__acym_scenario_history_line`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__acym_scenario_history_line` (
	`id` INT NOT NULL AUTO_INCREMENT,
	`scenario_process_id` INT NOT NULL,
