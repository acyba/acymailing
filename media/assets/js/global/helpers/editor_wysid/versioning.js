const acym_editorWysidVersioning = {
    ...
    setUndoAndAutoSave: function (initEdit = false) {
        ...
        if (0 == $campaignID.length || $campaignID.length > 0 && 0 != $campaignID.val()) {
            ...
            if (undefined != mailid && '' != mailid && 0 != mailid && false == initEdit) {
    ...
    setVersionControlCtrlZ: function () {
        jQuery(document).keydown(function (e) {
            if (jQuery('#acym__wysid__editor__source').height() > 0 || (undefined !== tinyMCE.focusedEditor && null !== tinyMCE.focusedEditor) || jQuery('#acym__wysid__context__button').is(':visible') || jQuery('#acym__wysid__context__follow').is(':visible') || jQuery('#acym__wysid__context__separator').is(':visible') || jQuery('#acym__wysid__context__share').is(':visible')) return;
