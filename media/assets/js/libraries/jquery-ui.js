    ...
    (function () {
        ...
        $.fn.extend({
            ...
            removeClass: (function (orig) {
                return function (classNames, speed, easing, callback) {
                    return arguments.length > 1 ? $.effects.animateClass.call(this, {remove: classNames}, speed, easing, callback) : orig.apply(this,
                        arguments
                    );
                };
            })($.fn.removeClass),
 ...
 */
    ...
    if ($.uiBackCompat !== false) {
        ...
        $.fn.button = (function (orig) {
            return function () {
                if (!this.length || (this.length && this[0].tagName !== 'INPUT') || (this.length && this[0].tagName === 'INPUT' && (this.attr('type')
                                                                                     !== 'checkbox'
                                                                                     && this.attr('type')
                                                                                     !== 'radio'))) {
                    return orig.apply(this, arguments);
	 ...
	 */
        _optionDatepicker: function (target, name, value) {
            ...
            if (arguments.length === 2 && typeof name === 'string') {
                return (name === 'defaults' ? $.extend({}, $.datepicker._defaults) : (inst ? (name === 'all' ? $.extend({}, inst.settings) : this._get(inst,
                    name
                )) : null));
            }
	 ...
	 */
        ...
        _checkExternalClick: function (event) {
            ...
            if ((($target[0].id
                  ...
                  && !($.datepicker._inDialog && $.blockUI))) || ($target.hasClass($.datepicker.markerClassName) && $.datepicker._curInst !== inst)) {
                $.datepicker._hideDatepicker();
            }
        },
        ...
        _selectMonthYear: function (id, select, period) {
            ...
            inst['selected' + (period === 'M' ? 'Month' : 'Year')] = inst['draw' + (period === 'M'
                                                                                    ? 'Month'
                                                                                    : 'Year')] = parseInt(select.options[select.selectedIndex].value, 10);
	 ...
	 */
        parseDate: function (format, value, settings) {
            ...
            var iFormat,
                ...
                shortYearCutoff = (typeof shortYearCutoffTemp !== 'string' ? shortYearCutoffTemp : new Date().getFullYear()
                                                                                                   % 100
	 ...
	 */
        ...
        _determineDate: function (inst, date, defaultDate) {
            var offsetNumeric = function (offset) {
                ...
                newDate = (date == null || date === '' ? defaultDate : (typeof date === 'string' ? offsetString(date) : (typeof date === 'number' ? (isNaN(date)
                                                                                                                                                     ? defaultDate
                                                                                                                                                     : offsetNumeric(
	 ...
	 */
        ...
        _generateHTML: function (inst) {
            var maxDraw,
                ...
                currentDate = this._daylightSavingAdjust((!inst.currentDay ? new Date(9999, 9, 9) : new Date(inst.currentYear,
                    inst.currentMonth,
                    inst.currentDay
                ))),
                minDate = this._getMinMaxDate(inst, 'min'),
            ...
            for (row = 0 ; row < numMonths[0] ; row++) {
                ...
                for (col = 0 ; col < numMonths[1] ; col++) {
                    ...
                    calender += '<div class=\'ui-datepicker-header ui-widget-header ui-helper-clearfix' + cornerClass + '\'>' + (/all|left/.test(cornerClass)
                                                                                                                                 ...
                                                                                                                                 ? (isRTL ? next : prev)
                                                                                                                                 : '') + (/all|right/.test(
                        cornerClass) && row === 0 ? (isRTL ? prev : next) : '') + this._generateMonthYearHeader(inst,
                        drawMonth,
                        drawYear,
                        minDate,
                        maxDate,
                    ...
                    for (dRow = 0 ; dRow < numRows ; dRow++) { // create date picker rows
                        ...
                        for (dow = 0 ; dow < 7 ; dow++) { // create date picker days
                            ...
                            unselectable = (otherMonth && !selectOtherMonths) || !daySettings[0] || (minDate && printDate < minDate) || (maxDate
                                                                                                                                         && printDate
                                                                                                                                         > maxDate);
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    ...
                    determineYear = function (value) {
                        var year = (value.match(/c[+\-].*/) ? drawYear + parseInt(value.substring(1), 10) : (value.match(/[+\-].*/) ? thisYear + parseInt(value,
                            10
                        ) : parseInt(value, 10)));
        ...
        _isInRange: function (inst, date) {
            ...
            return ((!minDate || date.getTime() >= minDate.getTime()) && (!maxDate || date.getTime() <= maxDate.getTime()) && (!minYear
                                                                                                                               || date.getFullYear()
                                                                                                                               >= minYear) && (!maxYear
                                                                                                                                               || date.getFullYear()
                                                                                                                                               <= maxYear));
    ...
    $.widget('ui.draggable', $.ui.mouse, {
        ...
        _setContainment: function () {
            ...
            this.containment = [
                ...
                - this.margins.left
                - this.margins.right,
                (isUserScrollable ? Math.max(ce.scrollHeight, ce.offsetHeight) : ce.offsetHeight) - (parseInt(c.css('borderBottomWidth'), 10) || 0) - (parseInt(
                    c.css('paddingBottom'),
                    10
        ...
        _convertPositionTo: function (d, pos) {
            ...
            return {
                top: (
                    ...
                    this.offset.parent.top * mod - ((this.cssPosition === 'fixed' ? -this.offset.scroll.top : (scrollIsRootNode ? 0 : this.offset.scroll.top))
                                                    * mod)),
                left: (
                    ...
                    // The offsetParent's offset without borders (offset + border)
                    this.offset.parent.left * mod - ((this.cssPosition === 'fixed' ? -this.offset.scroll.left : (scrollIsRootNode
                                                                                                                 ? 0
		 ...
		 */
            ...
            if (constrainPosition) {
                ...
                if (o.grid) {
                    ...
                    pageY = containment
                            ? ((top - this.offset.click.top >= containment[1] || top - this.offset.click.top > containment[3]) ? top : ((top
                    ...
                    pageX = containment
                            ? ((left - this.offset.click.left >= containment[0] || left - this.offset.click.left > containment[2]) ? left : ((left
        ...
        _setupHandles: function () {
            ...
            this._renderAxis = function (target) {
                ...
                for (i in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0]
                        .nodeName
    ...
    var widgetsSlider = $.widget('ui.slider', $.ui.mouse, {
        ...
        _mouseCapture: function (event) {
            ...
            this._clickOffset = mouseOverHandle ? {
                ...
                top: event.pageY - offset.top - (closestHandle.height() / 2) - (parseInt(closestHandle.css('borderTopWidth'), 10) || 0) - (parseInt(
                    closestHandle.css('borderBottomWidth'),
                    10
                ) || 0) + (parseInt(closestHandle.css('marginTop'), 10) || 0)
            };
    ...
    var widgetsSortable = $.widget('ui.sortable', $.ui.mouse, {
        ...
        _mouseStop: function (event, noPropagation) {
            ...
            if (this.options.revert) {
                ...
                if (!axis || axis === 'x') {
                    animation.left = cur.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body
                                                                                               ? 0
                                                                                               : this.offsetParent[0].scrollLeft);
                }
                if (!axis || axis === 'y') {
                    animation.top = cur.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body
                                                                                           ? 0
        ...
        _intersectsWith: function (item) {
            ...
            if (this.options.tolerance === 'pointer' || this.options.forcePointerForContainers || (this.options.tolerance
                                                                                                   !== 'pointer'
        ...
        _intersectsWithPointer: function (item) {
            ...
            return this.floating ? ((horizontalDirection === 'right' || verticalDirection === 'down') ? 2 : 1) : (verticalDirection && (verticalDirection
                                                                                                                                        === 'down' ? 2 : 1));
                        ...
                        if (inst && inst !== this && !inst.options.disabled) {
                            queries.push([
                                $.isFunction(inst.options.items) ? inst.options.items
                                                                       .call(inst.element[0], event, {item: this.currentItem}) : $(inst.options.items,
                                    inst.element
                                ),
                                inst
                            ]);
        ...
        _convertPositionTo: function (d, pos) {
            ...
            return {
                top: (
                    ...
                    // The offsetParent's offset without borders (offset + border)
                    this.offset.parent.top * mod - ((this.cssPosition === 'fixed' ? -this.scrollParent.scrollTop() : (scrollIsRootNode
                                                                                                                      ? 0
                ...
                left: (
                    ...
                    // The offsetParent's offset without borders (offset + border)
                    this.offset.parent.left * mod - ((this.cssPosition === 'fixed' ? -this.scrollParent.scrollLeft() : scrollIsRootNode
                                                                                                                       ? 0
		 ...
		 */
            ...
            if (this.originalPosition) { //If we are not dragging yet, we won't check for options
                ...
                if (o.grid) {
                    ...
                    pageY = this.containment ? ((top - this.offset.click.top >= this.containment[1] && top - this.offset.click.top <= this.containment[3])
                                                ? top
                                                : ((top - this.offset.click.top >= this.containment[1]) ? top - o.grid[1] : top + o.grid[1])) : top;

                    left = this.originalPageX + Math.round((pageX - this.originalPageX) / o.grid[0]) * o.grid[0];
                    pageX = this.containment ? ((left - this.offset.click.left >= this.containment[0] && left - this.offset.click.left <= this.containment[2])
                                                ? left
