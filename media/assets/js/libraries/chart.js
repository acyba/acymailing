...
// (hwb have alpha optional & 1 is default value)
            function hwbString(hwb, alpha){
                if(alpha === undefined){
                    alpha = (hwb[3] !== undefined
                        ? hwb[3]
                        : 1);
                }
                return "hwb(" + hwb[0] + ", " + hwb[1] + "%, " + hwb[2] + "%" + (alpha !== undefined && alpha !== 1
                        ? ", " + alpha
                        : "") + ")";
            }
...
//create a list of reverse color names
            ...
            function rgb2hsl(rgb){
                var r = rgb[0] / 255, g = rgb[1] / 255, b = rgb[2] / 255, min = Math.min(r, g, b), max = Math.max(r,
                    g,
                    b), delta = max - min, h, s, l;
            ...
            function rgb2hwb(rgb){
                var r = rgb[0], g = rgb[1], b = rgb[2], h = rgb2hsl(rgb)[0], w = 1 / 255 * Math.min(r, Math.min(g, b)), b = 1 - 1 / 255 * Math.max(r,
                        Math.max(g, b));
...
// DEPRECATIONS
            ...
            function computeFitCategoryTraits(index, ruler, options){
                ...
                return {
                    chunk: size / count, ratio: ratio, start: curr - (size / 2)
                };
            }
            ...
            function computeFlexCategoryTraits(index, ruler, options){
                ...
                var prev = index > 0
                    ? pixels[index - 1]
                    : null;
                var next = index < pixels.length - 1
                    ? pixels[index + 1]
                    : null;
                ...
                return {
                    chunk: size / ruler.stackCount, ratio: options.barPercentage, start: start
                };
            }
                ...
                Chart.controllers.bar = Chart.DatasetController.extend({
                    ...
                    _getStacks: function(last){
                        ...
                        for(i = 0; i < ilen; ++i){
                            ...
                            if(meta.bar && chart.isDatasetVisible(i) && (stacked === false || (stacked === true && stacks.indexOf(meta.stack) === -1) || (stacked === undefined && (meta.stack === undefined || stacks.indexOf(
                                    meta.stack) === -1)))){
                    ...
                    calculateBarIndexPixels: function(datasetIndex, index, ruler){
                        ...
                        return {
                            base: center - size / 2, head: center + size / 2, center: center, size: size
                        };
                    },
                ...
                Chart.controllers.bubble = Chart.DatasetController.extend({
                    ...
                    updateElement: function(point, index, reset){
                        ...
                        var x = reset
                            ...
                            : xScale.getPixelForValue(typeof data === 'object'
                            ? data
                            : NaN, index, dsIndex);
                        var y = reset
                            ? yScale.getBasePixel()
                    ...
                    _resolveElementOptions: function(point, index){
                        ...
                        // Scriptable options
                        var context = {
                            chart: chart, dataIndex: index, dataset: dataset, datasetIndex: me.index
                        };
                        ...
                        values.radius = resolve([custom.radius, data
                            ? data.r
                            : undefined, dataset.radius, options.radius], context, index);
            ...
            module.exports = function(Chart){
                ...
                Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
                    ...
                    updateElement: function(arc, index, reset){
                        ...
                        helpers.extend(arc, {
                            // Utility
                            _datasetIndex: me.index, _index: index,
            ...
            module.exports = function(Chart){
                ...
                Chart.controllers.line = Chart.DatasetController.extend({
                    ...
                    setHoverStyle: function(point){
                        ...
                        model.backgroundColor = custom.hoverBackgroundColor || helpers.valueAtIndexOrDefault(dataset.pointHoverBackgroundColor,
                                index,
                                helpers.getHoverColor(model.backgroundColor));
                        model.borderColor = custom.hoverBorderColor || helpers.valueAtIndexOrDefault(dataset.pointHoverBorderColor,
                                index,
                                helpers.getHoverColor(model.borderColor));
                        model.borderWidth = custom.hoverBorderWidth || helpers.valueAtIndexOrDefault(dataset.pointHoverBorderWidth,
                                index,
                                model.borderWidth);
                    },
                    ...
                    removeHoverStyle: function(point){
                        ...
                        model.radius = custom.radius || helpers.valueAtIndexOrDefault(dataset.pointRadius,
                                index,
            ...
            defaults._set('polarArea', {
                ...
                startAngle: -0.5 * Math.PI, legendCallback: function(chart){
                    var text = [];
                    text.push('<ul class="' + chart.id + '-legend">');
            ...
            module.exports = function(Chart){
                ...
                Chart.controllers.polarArea = Chart.DatasetController.extend({
                    ...
                    updateElement: function(arc, index, reset){
                        ...
                        helpers.extend(arc, {
                            // Utility
                            _datasetIndex: me.index, _index: index, _scale: scale,
            ...
            defaults._set('global', {
                animation: {
                    duration: 1000, easing: 'easeOutQuart', onProgress: helpers.noop, onComplete: helpers.noop
                }
            });
            ...
            module.exports = function(Chart){
                ...
                Chart.animationService = {
                    frameDuration: 17, animations: [], dropFrames: 0, request: null,
            ...
            module.exports = function(Chart){
                ...
                helpers.extend(Chart.prototype, /** @lends Chart */ {
                    ...
                    buildOrUpdateScales: function(){
                        ...
                        if(options.scale){
                            items.push({
                                options: options.scale, dtype: 'radialLinear', isDefault: true, dposition: 'chartArea'
                            });
                        }
                        ...
                        helpers.each(items, function(item){
                            ...
                            if(id in scales && scales[id].type === scaleType){
                                ...
                                scale = new scaleClass({
                                    id: id, type: scaleType, options: scaleOptions, ctx: me.ctx, chart: me
                                });
                    ...
                    update: function(config){
                        ...
                        if(!config || typeof config !== 'object'){
                            ...
                            config = {
                                duration: config, lazy: arguments[1]
                            };
                        }
                        ...
                        if(me._bufferedRender){
                            me._bufferedRequest = {
                                duration: config.duration, easing: config.easing, lazy: config.lazy
                            };
                        }else{
                            me.render(config);
                        }
                    ...
                    drawDataset: function(index, easingValue){
                        ...
                        var meta = me.getDatasetMeta(index);
                        var args = {
                            meta: meta, index: index, easingValue: easingValue
                        };
                    ...
                    _drawTooltip: function(easingValue){
                        ...
                        var args = {
                            tooltip: tooltip, easingValue: easingValue
                        };
                    ...
                    initToolTip: function(){
                        ...
                        me.tooltip = new Chart.Tooltip({
                            _chart: me, _chartInstance: me, // deprecated, backward compatibility
                            _data: me.data, _options: me.options.tooltips
                        }, me);
                    },
                ...
                function listenArrayEvents(array, listener){
                    ...
                    arrayEvents.forEach(function(key){
                        ...
                        Object.defineProperty(array, key, {
                            configurable: true, enumerable: false, value: function(){
                ...
                helpers.extend(Chart.DatasetController.prototype, {
                    ...
                    createMetaDataset: function(){
                        ...
                        return type && new type({
                                _chart: me.chart, _datasetIndex: me.index
                            });
                    },
                    ...
                    createMetaData: function(index){
                        ...
                        return type && new type({
                                _chart: me.chart, _datasetIndex: me.index, _index: index
                            });
                    },
            ...
            module.exports = function(Chart){
                ...
                helpers.splineCurve = function(firstPoint, middlePoint, afterPoint, t){
                    ...
                    return {
                        previous: {
                            x: current.x - fa * (next.x - previous.x), y: current.y - fa * (next.y - previous.y)
                        }, next: {
                            x: current.x + fb * (next.x - previous.x), y: current.y + fb * (next.y - previous.y)
                        }
                    };
                };
                ...
                helpers.splineCurveMonotone = function(points){
                    ...
                    var pointsWithTangents = (points || []).map(function(point){
                        return {
                            model: point._model, deltaK: 0, mK: 0
                        };
                    });
            ...
            defaults._set('global', {
                ...
                hover: {
                    onHover: null, mode: 'nearest', intersect: true, animationDuration: 400
                },
                onClick: null,
...
// It is this service's responsibility of carrying out that layout.
            module.exports = {
                ...
                update: function(chart, width, height){
                    ...
                    function getMinimumBoxSize(box){
                        ...
                        if(isHorizontal){
                            minSize = box.update(box.fullWidth
                                ? chartWidth
                                : maxChartAreaWidth, horizontalBoxHeight);
                        ...
                        minBoxSizes.push({
                            horizontal: isHorizontal, minSize: minSize, box: box,
                        });
                    }
                        ...
                        if(minBoxSize){
                            if(box.isHorizontal()){
                                ...
                                box.update(box.fullWidth
                                    ? chartWidth
                                    : maxChartAreaWidth, chartHeight / 2, scaleMargin);
                            }else{
                    ...
                    function finalFitVerticalBox(box){
                        ...
                        var scaleMargin = {
                            left: 0, right: 0, top: totalTopBoxesHeight, bottom: totalBottomBoxesHeight
                        };
            ...
            defaults._set('scale', {
                display: true, position: 'left', offset: false,
            ...
            module.exports = function(Chart){
                ...
                function parseFontOptions(options){
                    ...
                    return {
                        size: size, style: style, family: family, font: helpers.fontString(size, style, family)
                    };
                }
                ...
                Chart.Scale = Element.extend({
                    ...
                    getPadding: function(){
                        var me = this;
                        return {
                            left: me.paddingLeft || 0, top: me.paddingTop || 0, right: me.paddingRight || 0, bottom: me.paddingBottom || 0
                        };
                    },
                    ...
                    }, buildTicks: helpers.noop, afterBuildTicks: function(){
                    ...
                    getPixelForTick: function(index){
                        ...
                        if(me.isHorizontal()){
                            ...
                            var tickWidth = innerWidth / Math.max((me._ticks.length - (offset
                                    ? 0
                                    : 1)), 1);
            ...
            module.exports = function(Chart){
                ...
                Chart.scaleService = {
                    ...
                    defaults: {}, registerScaleType: function(type, scaleConstructor, scaleDefaults){
            ...
            defaults._set('global', {
                tooltips: {
                    ...
                    callbacks: {
                        ...
                        beforeLabel: helpers.noop, label: function(tooltipItem, data){
                            ...
                            return {
                                borderColor: view.borderColor, backgroundColor: view.backgroundColor
                            };
                        ...
                        // Args are: (tooltipItems, data)
                        beforeFooter: helpers.noop, footer: helpers.noop, afterFooter: helpers.noop
                    }
                }
            });
            ...
            module.exports = function(Chart){
                ...
                Chart.Tooltip = Element.extend({
                    ...
                    update: function(changed){
                        ...
                        var alignment = {
                            xAlign: existingModel.xAlign, yAlign: existingModel.yAlign
                        };
                        var backgroundPoint = {
                            x: existingModel.x, y: existingModel.y
                        };
                        var tooltipSize = {
                            width: existingModel.width, height: existingModel.height
                        };
                        var tooltipPosition = {
                            x: existingModel.caretX, y: existingModel.caretY
                        };
                ...
                Chart.Tooltip.positioners = {
                    ...
                    average: function(elements){
                        ...
                        return {
                            x: Math.round(x / count), y: Math.round(y / count)
                        };
                    },
            ...
            defaults._set('global', {
                elements: {
                    arc: {
                        backgroundColor: defaults.global.defaultColor, borderColor: '#fff', borderWidth: 2
                    }
                }
            });
            ...
            module.exports = Element.extend({
                ...
                getCenterPoint: function(){
                    ...
                    return {
                        x: vm.x + Math.cos(halfAngle) * halfRadius, y: vm.y + Math.sin(halfAngle) * halfRadius
                    };
                },
                ...
                tooltipPosition: function(){
                    ...
                    return {
                        x: vm.x + (Math.cos(centreAngle) * rangeFromCentre), y: vm.y + (Math.sin(centreAngle) * rangeFromCentre)
                    };
                },
            ...
            defaults._set('global', {
                elements: {
                    point: {
                        ...
                        hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1
                    }
                }
            });
            ...
            module.exports = Element.extend({
                ...
                tooltipPosition: function(){
                    var vm = this._view;
                    return {
                        x: vm.x, y: vm.y, padding: vm.radius + vm.borderWidth
                    };
                },
            ...
            module.exports = Element.extend({
                draw: function(){
                    ...
                    if(borderWidth){
                        ...
                        var borderLeft = left + (borderSkipped !== 'left'
                                ? halfStroke * signX
                                : 0);
                        var borderRight = right + (borderSkipped !== 'right'
                                ? -halfStroke * signX
                                : 0);
                        var borderTop = top + (borderSkipped !== 'top'
                                ? halfStroke * signY
                                : 0);
                        var borderBottom = bottom + (borderSkipped !== 'bottom'
                                ? -halfStroke * signY
                                : 0);
...
// DEPRECATIONS
            ...
            module.exports = {
                ...
                toPadding: function(value){
                    ...
                    return {
                        top: t, right: r, bottom: b, left: l, height: t + b, width: l + r
                    };
                },
            ...
            function initCanvas(canvas, config){
                ...
                canvas[EXPANDO_KEY] = {
                    initial: {
                        height: renderHeight, width: renderWidth, style: {
                            display: style.display, height: style.height, width: style.width
                        }
                    }
                };
...
// @TODO Make possible to select another platform at build time.
            var implementation = dom._enabled
                ? dom
                : basic;
...
// @todo if (fill[0] === '#')
                ...
                afterDatasetsUpdate: function(chart, options){
                    ...
                    for(i = 0; i < count; ++i){
                        ...
                        if(el && el._model && el instanceof elements.Line){
                            source = {
                                visible: chart.isDatasetVisible(i), fill: decodeFill(el, i, count), chart: chart, el: el
                            };
                        }
            ...
            defaults._set('global', {
                legend: {
                    display: true, position: 'top', fullWidth: true, reverse: false, weight: 1000,
                    ...
                    labels: {
                        boxWidth: 40, padding: 10, // Generates labels shown in the legend
            ...
            var Legend = Element.extend({
                ...
                beforeSetDimensions: noop, setDimensions: function(){
                    var me = this;
                    // Set the unconstrained dimension before label rotation
                    if(me.isHorizontal()){
                        // Reset position before calculating rotation
                    ...
                    if(display){
                        ...
                        if(isHorizontal){
                            ...
                            helpers.each(me.legendItems, function(legendItem, i){
                                ...
                                hitboxes[i] = {
                                    left: 0, top: 0, width: width, height: fontSize
                                };
                            ...
                            helpers.each(me.legendItems, function(legendItem, i){
                                ...
                                // Store the hitbox width and height here. Final position will be updated in `draw`
                                hitboxes[i] = {
                                    left: 0, top: 0, width: itemWidth, height: fontSize
                                };
                            });
                ...
                draw: function(){
                    ...
                    if(opts.display){
                        ...
                        if(isHorizontal){
                            cursor = {
                                x: me.left + ((legendWidth - lineWidths[0]) / 2), y: me.top + labelOpts.padding, line: 0
                            };
                        }else{
                            cursor = {
                                x: me.left + labelOpts.padding, y: me.top + labelOpts.padding, line: 0
                            };
                        }
            ...
            function createNewLegendAndAttach(chart, legendOpts){
                var legend = new Legend({
                    ctx: chart.ctx, options: legendOpts, chart: chart
                });
            ...
            defaults._set('global', {
                title: {
                    display: false, fontStyle: 'bold', fullWidth: true, lineHeight: 1.2, padding: 10, position: 'top', text: '', weight: 2000         // by default greater than legend (1000) to be above
                }
            });
                ...
                draw: function(){
                    ...
                    if(opts.display){
                        ...
                        if(me.isHorizontal()){
                            ...
                            maxWidth = bottom - top;
                            rotation = Math.PI * (opts.position === 'left'
                                    ? -0.5
                                    : 0.5);
                        }
            ...
            function createNewTitleBlockAndAttach(chart, titleOpts){
                var title = new Title({
                    ctx: chart.ctx, options: titleOpts, chart: chart
                });
            ...
            module.exports = function(Chart){
                ...
                var DatasetScale = Chart.Scale.extend({
                    ...
                    getPixelForValue: function(value, index){
                        ...
                        var offsetAmt = Math.max((me.maxIndex + 1 - me.minIndex - (offset
                            ? 0
                            : 1)), 1);
                        ...
                        var offset = me.options.offset;
                        var value;
                        var offsetAmt = Math.max((me._ticks.length - (offset
                            ? 0
                            : 1)), 1);
                        var horz = me.isHorizontal();
                        var valueDimension = (horz
                                ? me.width
                                : me.height) / offsetAmt;
                ...
                var LinearScale = Chart.LinearScaleBase.extend({
                    ...
                    determineDataLimits: function(){
                        ...
                        if(me.isHorizontal()){
                            ...
                            maxTicks = Math.min(tickOpts.maxTicksLimit
                                ? tickOpts.maxTicksLimit
                                : 11, Math.ceil(me.height / (2 * tickFontSize)));
                        }
            ...
            module.exports = function(Chart){
                ...
                Chart.LinearScaleBase = Chart.Scale.extend({
                    ...
                    }, getTickLimit: noop, handleDirectionalChanges: noop,
                ...
                var LogarithmicScale = Chart.Scale.extend({
                    determineDataLimits: function(){
                        ...
                        var generationOptions = {
                            min: tickOpts.min, max: tickOpts.max
                        };
            ...
            module.exports = function(Chart){
                ...
                var defaultConfig = {
                    ...
                    animate: true, position: 'chartArea',

                    angleLines: {
                        display: true, color: 'rgba(0, 0, 0, 0.1)', lineWidth: 1
                    },
                ...
                function getPointLabelFontOptions(scale){
                    ...
                    return {
                        size: fontSize, style: fontStyle, family: fontFamily, font: font
                    };
                }
                ...
                function measureLabelSize(ctx, fontSize, label){
                    if(helpers.isArray(label)){
                        return {
                            w: helpers.longestText(ctx, ctx.font, label), h: (label.length * fontSize) + ((label.length - 1) * 1.5 * fontSize)
                        };
                    }

                    return {
                        w: ctx.measureText(label).width, h: fontSize
                    };
                }
                ...
                function determineLimits(angle, pos, size, min, max){
                    if(angle === min || angle === max){
                        ...
                        return {
                            start: pos - size - 5, end: pos
                        };
                    }

                    return {
                        start: pos, end: pos + size + 5
                    };
                }
                ...
                function fitWithPointLabels(scale){
                    ...
                    var furthestLimits = {
                        r: scale.width, l: 0, t: scale.height, b: 0
                    };
                    var furthestAngles = {};
                ...
                var LinearRadialScale = Chart.LinearScaleBase.extend({
                    setDimensions: function(){
                        ...
                        me.min = (min === Number.POSITIVE_INFINITY
                            ? 0
                            : min);
                        ...
                        return Math.min(tickOpts.maxTicksLimit
                            ? tickOpts.maxTicksLimit
                            : 11, Math.ceil(this.drawingArea / (1.5 * tickFontSize)));
                    }, convertTicksToLabels: function(){
                        var me = this;
...
// Integer constants are from the ES6 spec.
            ...
            var INTERVALS = {
                millisecond: {
                    common: true, size: 1, steps: [1, 2, 5, 10, 20, 50, 100, 250, 500]
                }, second: {
                    common: true, size: 1000, steps: [1, 2, 5, 10, 30]
                }, minute: {
                    common: true, size: 60000, steps: [1, 2, 5, 10, 30]
                }, hour: {
                    common: true, size: 3600000, steps: [1, 2, 3, 6, 12]
                }, day: {
                    common: true, size: 86400000, steps: [1, 2, 5]
                }, week: {
                    common: false, size: 604800000, steps: [1, 2, 3, 4]
                }, month: {
                    common: true, size: 2.628e9, steps: [1, 2, 3]
                }, quarter: {
                    common: false, size: 7.884e9, steps: [1, 2, 3, 4]
                }, year: {
                    common: true, size: 3.154e10
                }
            };
...
// @see adapted from http://www.anujgakhar.com/2014/03/01/binary-search-in-javascript/
            ...
            function generate(min, max, capacity, options){
                ...
                first = first.startOf(weekday
                    ? 'day'
                    : minor);
                last = last.startOf(weekday
                    ? 'day'
                    : minor);
            ...
            module.exports = function(Chart){
                ...
                var TimeScale = Chart.Scale.extend({
                    ...
                    determineDataLimits: function(){
                        ...
                        me._table = [];
                        me._timestamps = {
                            data: timestamps, datasets: datasets, labels: labels
                        };
                    },
                    ...
                    getValueForPixel: function(pixel){
                        ...
                        var pos = (size
                                ? (pixel - start) / size
                                : 0) * (me._offsets.left + 1 + me._offsets.left) - me._offsets.right;
